...
async function handleMention(mentionType: string, mentionData: unknown): Promise<void> {
	try {
...
// Example usage
const sampleText =
	'Create a new world @world{"name":"Eldoria", "mainDesc":"A magical realm"} and a campaign @campaign{"name":"The Lost Artifacts", "world":"60a1234b5678c90defghijkl"}';
